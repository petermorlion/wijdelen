...
namespace Peergroups.Theme {
    public class MobileShapeTableProvider : IShapeTableProvider {
        ...
        public void Discover(ShapeTableBuilder builder) {
            builder.Describe("Navigation")
                .OnDisplaying(display => {
                    if (IsMobileBrowser()) display.ShapeMetadata.Alternates.Add("Navigation__mobile");
                });
        ...
        private bool IsMobileBrowser() {
            var userAgent = _orchardServices.WorkContext.HttpContext.Request.ServerVariables["HTTP_USER_AGENT"];
